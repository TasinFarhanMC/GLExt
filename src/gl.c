...
static void glad_gl_load_GL_ARB_texture_buffer_range(GLADuserptrloadfunc load,
                                                     void *userptr) {
...
static int glad_gl_find_extensions_gl(void) {
  ...
  GLAD_GL_ARB_explicit_uniform_location =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_explicit_uniform_location");
  GLAD_GL_ARB_map_buffer_alignment =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_map_buffer_alignment");
  GLAD_GL_ARB_multi_draw_indirect =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_multi_draw_indirect");
  GLAD_GL_ARB_separate_shader_objects =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_separate_shader_objects");
  GLAD_GL_ARB_shading_language_420pack =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shading_language_420pack");
  GLAD_GL_ARB_texture_buffer_range =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_buffer_range");
  GLAD_GL_ARB_texture_storage =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_storage");
  GLAD_GL_ARB_vertex_attrib_binding =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_attrib_binding");
